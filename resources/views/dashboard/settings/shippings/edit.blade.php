                              ...
                              <h2 class="text-center border-bottom py-2"><i class="fa fa-truck fa-4x"></i>{{__('admin/sidebar.Edit')}}</h2>
                                <form class="mt-3" action="{{ route('Shipping.Methods.Update',$shippingmethod->id) }}" method="POST">
                                   @csrf
                                    ...
                                    <input type="text" class="form-control" id="Name"  value="{{$shippingmethod->value}}">
                                    </div>
                                    <div class="form-group">
                                      <label for="Password">{{__('admin/sidebar.Cost')}}</label>
                                    <input type="text" class="form-control" id="Password" value="{{$shippingmethod->plain_value}}">
                                    </div>
