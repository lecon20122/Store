...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/amdin/images/ico/favicon.ico') }} ">
    <link
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('assets/admin/'.getFolder().'/core/menu/menu-types/vertical-content-menu.css') }}">
